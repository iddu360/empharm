    ...
    <section class="section">
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12 px-3">
                  <div class="d-flex justify-content-between my-1">
                    <label for="" class="form-label">Drug Code</label>
                    <input type="text" name="" class="form-control-sm bg-transparent">
                  </div>
                  <div class="d-flex justify-content-between my-1">
      ...
      <div class="row py-2">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">Manage Medicine Stock</h5>
              ...
              <table class="table table-hover" id="">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><i class="bi bi-eye"></i> &nbsp;<i class="bi bi-eye"></i></td>
                  </tr>
                </tbody>
              </table>
