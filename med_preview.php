  ...
  if (isset($_POST["add_to_cart"])) {
    if (isset($_SESSION["shopping_cart"])) {
      ...
      if (!in_array($_GET["id"], $item_array_id)) {
        ...
        echo '<script>window.location="./Your_item_preview</script>';
      }
    } else {
      $item_array = array(
        'item_id' => $id,
    ...
    if ($_GET["action"] == "add") {
      foreach ($_SESSION["shopping_cart"] as $keys => $values) {
        if ($values["item_id"] == $id) {
          ...
          echo '<script>window.locaton="./Your_item_preview"</script>';
        }
      }
...
<body>
  ...
  <div class="container mt-5 pt-3">
    <div class="d-flex">
      <div class="col-4 m-1">
        <form action="cart.php?action=add&id=<?php echo $row["drug_id"]; ?>">
          <div class="card">
            <?php
              ...
              <div class="card-body text-center p-1">
                ...
                <div class="row">
                  <div class="d-flex">
                    <div class="col-4">
                      <div class="card m-1">
                        <img src="./assets/img/<?php echo $row['drug_image']; ?>" alt="alt drug" class="img-fluid card-img-top">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <input type="hidden" name="hidden_name" value="<?php echo $row['drug_name']; ?>">
        ...
        <div class="card my-1 p-1">
          ...
          <hr>
          <div>
            <p class="mb-0">Find related Medication</p>
            <div class="d-flex">
              <div class="d-flex">
                <?php
                ...
                ?>
                  <div class="col-3">
                    <div class="card m-1">
                      <img src="./assets/img/<?php echo $row2['drug_image']; ?>" alt="alt drug" class="img-fluid card-img-top">
                      <div class="card-body py-1">
                        <small class="my-0 card-text"><?php echo $row2['drug_name']; ?></small>
                      </div>
                    <?php
                  }
                    ?>
      ...
      <div class="col-8 m-1">
        <div class="card p-1">
          <h5 class="fw-bold">Drug Information</h5>
          <hr>
          <p class="mb-0"><b>Drug Name:</b> <?php echo $row['drug_name']; ?></p>
          <p class="mb-0"><b>Brand Name:</b> <?php echo $row['brand_name']; ?></p>
          <p class="mb-0"><b>Drug Classification:</b> <?php echo $row['drug_class']; ?></p>
          <p class="mb-0"><b>Indications:</b> <?php echo $row['description']; ?></p>
          <p class="mb-0"><b>Dosage Form:</b> <?php echo $row['dtype']; ?> </p>
          <p class="mb-0"><b>Dosage Strength:</b> <?php echo $row['strength']; ?></p>
          <p class="mb-0"><b>Route of Administration:</b> <?php echo $row['route']; ?></p>
          <p class="mb-0"><b>Mechanism of Action:</b> <?php echo $row['description']; ?></p>
          <p class="mb-0"><b>Contraindications:</b> <?php echo $row['contraindications']; ?></p>
          <p class="mb-0"><b>Side Effects:</b> <?php echo $row['side_effects']; ?></p>
          <p class="mb-0"><b>Precautions and Warnings:</b> <?php echo $row['precaution']; ?></p>
          <p class="mb-0"><b>Storage Requirements:</b> Cool dry Place</p>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td><a href="./Your_item_preview?action=add&id=<?php echo $values["item_id"]; ?>"><span class="bx bx-plus bg-primary rounded-1"></span></a>
                            <a href="./Your_item_preview?action=remove&id=<?php echo $values["item_id"]; ?>">
